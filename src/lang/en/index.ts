...
export default {
  ...
  operations: {
    ...
    [TransactionStatus.Finalized]: {
      ...
      [Operation.CreateVault]: 'Vault created',
      [Operation.CloseVault]: 'Vault closed',
      [Operation.DepositCollateral]: 'Deposited {amount} {symbol}',
      [Operation.RepayVaultDebt]: 'Debt repaid {amount} {symbol}',
    ...
    [TransactionStatus.Error]: {
      ...
      [Operation.CreateVault]: 'Failed to create vault',
      [Operation.CloseVault]: 'Failed to close vault',
