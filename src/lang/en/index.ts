...
export default {
  ...
  connection: {
    ...
    install: 'No polkadot.js extension found. Install it and <a href="/" class="wallet-connection-link">reload</a> the page.<br/><span class="wallet-connection-link">https://polkadot.js.org/extension/</span>',
