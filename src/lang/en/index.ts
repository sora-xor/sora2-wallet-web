...
export default {
  ...
  operations: {
    ...
    [TransactionStatus.Finalized]: {
      ...
      [Operation.OrderBookPlaceLimitOrder]: 'Limit order of {amount} {symbol} at {price} {symbol2} placed',
    ...
    [TransactionStatus.Error]: {
      ...
      [Operation.OrderBookPlaceLimitOrder]: 'Failed to place limit order of {amount} {symbol} at {price} {symbol}',
