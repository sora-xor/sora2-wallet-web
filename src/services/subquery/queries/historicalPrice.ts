...
import type { EntitiesConnectionQueryResponse, AssetSnapshotEntity } from '../types';

export const HistoricalPriceQuery = gql<EntitiesConnectionQueryResponse<AssetSnapshotEntity>>`
